// Manually added types for query-string because the official types ship with a newer version of query-string that breaks in IE.
// remove this type definition when query-string is updated to v6.12.1 or later
