/** @module LampIllustration */
import React from 'react';
import PropTypes from 'prop-types';

/** Displays the LampIllustration component.
 * @param {object} props - Component props.
 * @returns {*} - JSX representation of the LampIllustration component.
 */
const LampIllustration = ({width, height, fill, on, className, onClick}) => (
  <svg
    className={className}
    onClick={onClick}
...
LampIllustration.propTypes = {
  ...
  on: PropTypes.bool,
  /** Optional onClick handler which allows you to turn the lamp on/off. */
  onClick: PropTypes.func,
  /** Additional class names to apply to the container. */
  className: PropTypes.string,
};

LampIllustration.defaultProps = {
  width: '265',
  height: '160',
  fill: '#ffffff',
};
