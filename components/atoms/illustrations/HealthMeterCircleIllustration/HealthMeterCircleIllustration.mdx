...
The HealthMeterCircleIllustration component creates a heart meter illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
