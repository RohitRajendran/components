        ...
        >
          <defs>
            ...
            <pattern
              ...
              viewBox="0 0 4 4"
            >
              <rect className="gift-cls-1" width="4" height="4" />
              <circle className="gift-cls-2" cx="3" cy="4" r="0.35" />
              <circle className="gift-cls-2" cx="1" cy="4" r="0.35" />
              <circle className="gift-cls-2" cx="4" cy="2" r="0.35" />
              <circle className="gift-cls-2" cx="2" cy="2" r="0.35" />
              <circle className="gift-cls-2" cy="2" r="0.35" />
              <circle className="gift-cls-2" cx="3" r="0.35" />
            ...
            >
              <rect className="gift-cls-1" width="4" height="4" />
              <circle className="gift-cls-3" cx="3" cy="4" r="0.35" />
              <circle className="gift-cls-3" cx="1" cy="4" r="0.35" />
              <circle className="gift-cls-3" cx="4" cy="2" r="0.35" />
              <circle className="gift-cls-3" cx="2" cy="2" r="0.35" />
              <circle className="gift-cls-3" cy="2" r="0.35" />
              <circle className="gift-cls-3" cx="3" r="0.35" />
            ...
            >
              <rect className="gift-cls-1" width="4" height="4" />
              <circle className="gift-cls-4" cx="3" cy="4" r="0.35" />
              <circle className="gift-cls-4" cx="1" cy="4" r="0.35" />
              <circle className="gift-cls-4" cx="4" cy="2" r="0.35" />
              <circle className="gift-cls-4" cx="2" cy="2" r="0.35" />
              <circle className="gift-cls-4" cy="2" r="0.35" />
              <circle className="gift-cls-4" cx="3" r="0.35" />
