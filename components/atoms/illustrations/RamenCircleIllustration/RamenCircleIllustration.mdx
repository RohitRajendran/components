...
The RamenCircleIllustration component creates a ramen illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
