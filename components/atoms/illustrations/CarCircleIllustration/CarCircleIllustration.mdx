...
The CarCircleIllustration component creates a car illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
