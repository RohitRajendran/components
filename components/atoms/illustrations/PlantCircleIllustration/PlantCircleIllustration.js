 ...
 * @returns {JSX} Returns the PlantCircleIllustration component.
 */
const PlantCircleIllustration = ({
  illuminate,
  color,
  draft,
  width,
  ...
  const [illuminated, setIllumination] = useState(false);
  ...
  const elementProps = {
    ...
    onClick: () => setIllumination(!illuminated),
  };
...
PlantCircleIllustration.propTypes = {
...
export default PlantCircleIllustration;
