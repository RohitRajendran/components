        ...
        >
          <defs>
            ...
            <pattern
              ...
              viewBox="0 0 4 4"
            >
              <rect className="shopping-cls-1" width="4" height="4" />
              <circle className="shopping-cls-2" cx="3" cy="4" r="0.35" />
              <circle className="shopping-cls-2" cx="1" cy="4" r="0.35" />
              <circle className="shopping-cls-2" cx="4" cy="2" r="0.35" />
              <circle className="shopping-cls-2" cx="2" cy="2" r="0.35" />
              <circle className="shopping-cls-2" cy="2" r="0.35" />
              <circle className="shopping-cls-2" cx="3" r="0.35" />
            ...
            >
              <rect className="shopping-cls-1" width="4" height="4" />
              <circle className="shopping-cls-3" cx="3" cy="4" r="0.35" />
              <circle className="shopping-cls-3" cx="1" cy="4" r="0.35" />
              <circle className="shopping-cls-3" cx="4" cy="2" r="0.35" />
              <circle className="shopping-cls-3" cx="2" cy="2" r="0.35" />
              <circle className="shopping-cls-3" cy="2" r="0.35" />
              <circle className="shopping-cls-3" cx="3" r="0.35" />
            ...
            >
              <rect className="shopping-cls-1" width="4" height="4" />
              <circle className="shopping-cls-4" cx="3" cy="4" r="0.35" />
              <circle className="shopping-cls-4" cx="1" cy="4" r="0.35" />
              <circle className="shopping-cls-4" cx="4" cy="2" r="0.35" />
              <circle className="shopping-cls-4" cx="2" cy="2" r="0.35" />
              <circle className="shopping-cls-4" cy="2" r="0.35" />
              <circle className="shopping-cls-4" cx="3" r="0.35" />
          ...
          <g id="experience-color-2">
            ...
            />
            <polygon
              className="shopping-cls-9"
              points="107.03 45.83 105.11 43.52 103.19 45.83 101.27 43.52 99.36 45.83 97.44 43.52 95.52 45.83 93.6 43.52 91.68 45.83 89.76 43.52 87.84 45.83 85.92 43.52 84 45.83 82.08 43.52 80.16 45.83 78.3 43.59 76.44 45.83 74.52 43.52 72.61 45.83 70.69 43.52 68.77 45.83 66.85 43.52 64.93 45.83 63.01 43.52 61.09 45.83 59.17 43.52 57.25 45.83 55.33 43.52 53.41 45.83 51.49 43.52 51.49 107.01 108.94 107.01 108.94 43.53 107.03 45.83"
            />
            <path
              className="shopping-cls-3"
              d="M51.5,43.52V107h57.44C78.87,107,51.48,75.26,51.5,43.52Z"
            />
            <path
              className="shopping-cls-10"
              d="M51.5,43.52V107h57.44C78.87,107,51.48,75.26,51.5,43.52Z"
            />
            <rect
              className="shopping-cls-5"
              x="97.26"
              y="75.58"
              width="11.24"
              height="19.48"
            ...
            />
            <circle className="shopping-cls-5" cx="67.99" cy="50.06" r="1.6" />
            <circle className="shopping-cls-5" cx="92.24" cy="50.06" r="1.6" />
          </g>
        </svg>
      );
    } else if (color) {
        ...
        >
          ...
          <g id="experience-gray">
            ...
            <path
              ...
              d="M68.67,50.06V42.29c0-7.06,5.14-13,11.49-13s11.5,5.92,11.5,13c0,0,0,7.72,0,7.77H93c0-.05,0-7.73,0-7.77,0-7.87-5.74-14.24-12.82-14.24S67.35,34.42,67.35,42.29c0,0,0,7.72,0,7.77Z"
            />
            <circle className="shopping-cls-9" cx="67.99" cy="50.06" r="1.6" />
            <circle className="shopping-cls-9" cx="92.24" cy="50.06" r="1.6" />
          </g>
        </svg>
      );
    } else {
        ...
        >
          ...
          <g id="experience-purple">
            ...
            <path
              ...
              d="M68.67,50.06V42.29c0-7.06,5.14-13,11.49-13s11.5,5.92,11.5,13c0,0,0,7.72,0,7.77H93c0-.05,0-7.73,0-7.77,0-7.87-5.74-14.24-12.82-14.24S67.35,34.42,67.35,42.29c0,0,0,7.72,0,7.77Z"
            />
            <circle className="shopping-cls-7" cx="67.99" cy="50.06" r="1.6" />
            <circle className="shopping-cls-7" cx="92.24" cy="50.06" r="1.6" />
            <polygon
              className="shopping-cls-2"
              points="107.03 45.83 105.11 43.52 103.19 45.83 101.27 43.52 99.36 45.83 97.44 43.52 95.52 45.83 93.6 43.52 91.68 45.83 89.76 43.52 87.84 45.83 85.92 43.52 84 45.83 82.08 43.52 80.16 45.83 78.3 43.59 76.44 45.83 74.52 43.52 72.61 45.83 70.69 43.52 68.77 45.83 66.85 43.52 64.93 45.83 63.01 43.52 61.09 45.83 59.17 43.52 57.25 45.83 55.33 43.52 53.41 45.83 51.49 43.52 51.49 107.01 108.94 107.01 108.94 43.53 107.03 45.83"
            />
