...
The GivingCircleIllustration component creates a gift illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
