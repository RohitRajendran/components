...
The PaintingCircleIllustration component creates a painting illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
