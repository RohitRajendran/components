...
The HealthCircleIllustration component creates a stethoscope illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
