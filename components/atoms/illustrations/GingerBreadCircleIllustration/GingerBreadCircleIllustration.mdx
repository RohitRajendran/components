...
The GingerBreadCircleIllustration component creates a ginger bread illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
