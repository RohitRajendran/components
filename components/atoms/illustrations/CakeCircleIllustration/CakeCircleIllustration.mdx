...
The CakeCircleIllustration component creates a cake illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
