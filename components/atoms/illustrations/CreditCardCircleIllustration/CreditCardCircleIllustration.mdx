...
The CreditCardCircleIllustration component creates a credit card illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
