...
The DollarCircleIllustration component creates a dollar illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
