...
The ShoppingCircleIllustration component creates a shopping bag illustration using inline SVG. This illustration is commonly used within McGonnagall introduction cards.
